...
- full command line: /home/rock/project/gem5/build/ARM/gem5.opt --outdir=/home/rock/project/gem5/runs/baseline/hello_manual/latest /home/rock/project/gem5/configs/deprecated/example/se.py -n 1 --cpu-type=DerivO3CPU --caches --l2cache --mem-size=2GB --maxinsts=50000000 -c tests/test-progs/hello/bin/arm/linux/hello
- output directory: /home/rock/project/gem5/runs/baseline/hello_manual/latest
- workload path: tests/test-progs/hello/bin/arm/linux/hello
- workload options: none
- run tag: hello_manual
- ISA: ARM
